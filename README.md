...
```bash
curl -sL [https://raw.githubusercontent.com/YOUR_USERNAME/yt-termux/main/install.sh](https://raw.githubusercontent.com/YOUR_USERNAME/yt-termux/main/install.sh) | bash
